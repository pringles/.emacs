...
(defun color-theme-ravis-light ()
  (interactive)
  (color-theme-install
   '(color-theme-ravis-light
...
(defun color-theme-ravis-dark()
  (interactive)
  (color-theme-install
   '(color-theme-ravis-dark
     ...
     (font-lock-builtin-face ((t (:foreground "#9ebfc2"))))
     (font-lock-comment-face ((t (:foreground "#888a85"))))
     (font-lock-function-name-face ((t (:foreground "#edd400"))))
     (font-lock-keyword-face ((t (:foreground "#729fcf"))))
     (font-lock-string-face ((t (:foreground "#b6b776"))))
